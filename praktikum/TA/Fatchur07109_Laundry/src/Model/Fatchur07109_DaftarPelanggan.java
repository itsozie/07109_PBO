...
public class Fatchur07109_DaftarPelanggan {
    ...
    public ArrayList<Fatchur07109_DaftarPelangganEntity> alldataplg() {
            ...
            if (daftarPelangganArrayList.size() == 0) {
                ...
                if (IndexPaket == daftarPelanggan.getIndexpaket()) {
                    ...
                    System.out.println("No : " + (index++)
                            ...
                            + "\nBerat         : " + daftarPelanggan.getPelanggan().getBerat()
                            + "\nAlamat        : " + daftarPelanggan.getPelanggan().getAlamat()
                            + "\nPaket         : " + Fatchur07109_PaketEntity.paket[daftarPelanggan.getIndexpaket()]
