...
public class fatchur_07109_OwnerEntity {
        ...
        String Fatchur_07109_antrian;
        int Fatchur_07109_indexpaket;
        ...
        public fatchur_07109_OwnerEntity(
         ...
         this.Fatchur_07109_antrian = Fatchur_07109_antrian;
         this.Fatchur_07109_indexpaket = Fatchur_07109_paket;
    ...
    public String getFatchur_07109_antrian() {
        return Fatchur_07109_antrian;
    }

    public int getFatchur_07109_paket() {
        return Fatchur_07109_indexpaket;
    }
